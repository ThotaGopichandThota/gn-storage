...
import (
	...
	"github.com/ThotaGopichandThota/gn-core3/hashing"
	"github.com/ThotaGopichandThota/gn-core3/hashing/blake2b"
	"github.com/ThotaGopichandThota/gn-core3/hashing/fnv"
	"github.com/ThotaGopichandThota/gn-core3/hashing/keccak"
	storageCore "github.com/ThotaGopichandThota/gn-core3/storage"
	logger "github.com/ThotaGopichandThota/gn-logger1"
	"github.com/ThotaGopichandThota/gn-storage/common"
	"github.com/ThotaGopichandThota/gn-storage/fifocache"
	"github.com/ThotaGopichandThota/gn-storage/leveldb"
	"github.com/ThotaGopichandThota/gn-storage/lrucache"
	"github.com/ThotaGopichandThota/gn-storage/memorydb"
	"github.com/ThotaGopichandThota/gn-storage/monitoring"
	"github.com/ThotaGopichandThota/gn-storage/types"
)
...
func NewDB(argDB ArgDB) (types.Persister, error) {
	var db types.Persister
	var err error
	fmt.Println("***************************", MaxRetriesToCreateDB)
	for i := 0; i < MaxRetriesToCreateDB; i++ {
		...
		fmt.Println("==================================", SleepTimeBetweenCreateDBRetries)
